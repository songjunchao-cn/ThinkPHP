<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wamp64\www\tp5\public/../application/index\view\article\article.html";i:1526481630;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.sjc.com/static/index/css/article.css">
</head>
<body>
      ...
      <div class="container">
        ...
        <div class="row" >
          ...
          <div class="col-md-12 article-title">
            ...
            <!-- Section title -->
            <h2 class="title -black text-center">咨讯</h2>

            <!-- <span class="subtitle h3 -yellow">就写点html</span> -->
  ...
  <img class="center-block" src="http://www.sjc.com/<?php echo $article['article_pic']; ?>" title="" alt="无缩略图">
              <span class="h1 -black text-center">标题：<?php echo $article['article_title']; ?></span>
              <p class="title -black text-center">内容：<?php echo $article['article_content']; ?></p>

              <h3 class="title -black text-center">作者：<?php echo $article['article_author']; ?></h3>
