              ...
              <input type="hidden" name="article_id" value="<?php echo $article['article_id']; ?>">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" value="<?php echo $article['article_desc']; ?>"
                        class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" id="L_tel" name="content"
                         autocomplete="on" value="<?php echo $article['article_content']; ?>"
                          class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="file" id="L_tel" name="pic" required lay-verify="file"
                         autocomplete="on" value="<?php echo $article['article_pic']; ?>"
                          class="layui-input">
