<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"C:\wamp64\www\tp5\public/../application/admin\view\web\weblist.html";i:1521872250;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
              ...
              <button class="layui-btn" onclick="web_add('添加用户','webadd.html','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
                ...
                <tbody>
                  <?php if(is_array($weblist) || $weblist instanceof \think\Collection || $weblist instanceof \think\Paginator): $i = 0; $__LIST__ = $weblist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>
                            <u style="cursor:pointer" onclick="web_show('张三','web-show.html','10001','360','400')">
                        ...
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none"  onclick="web_password('修改密码','webpassword','10001','600','400')"
    ...
    <script>
       ...
       //      btn: ['确定', '取消'],
       //      }, function() {                        // 当确定时执行
       //     $.post("<?php echo url('web/webdel'); ?>", {    // 网址、数据、成功后操作
       //     "_token": "{{ csrf_token() }}",
       //    "_method": "delete"
       //     }, function(data) {
       //     if (data.status == 0) {
