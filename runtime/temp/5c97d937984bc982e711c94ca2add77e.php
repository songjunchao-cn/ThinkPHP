<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wamp64\www\tp5\public/../application/admin\view\video\videolist.html";i:1522165199;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
              ...
              <button class="layui-btn" onclick="video_add('添加文章','videoadd.html','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
                ...
                <tbody>
                  <?php if(is_array($videolist) || $videolist instanceof \think\Collection || $videolist instanceof \think\Paginator): $i = 0; $__LIST__ = $videolist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>
                            <u style="cursor:pointer" onclick="video_show('张三','video-show.html','10001','360','400')">
                        ...
                        <td class="td-manage">
                            <a style="text-decoration:none" onclick="video_stop(this,'10001')" href="javascript:;" title="停用">
                            ...
                            <a style="text-decoration:none"  onclick="video_password('修改密码','videopassword','10001','600','400')"
    ...
    <script>
       ...
       //      btn: ['确定', '取消'],
       //      }, function() {                        // 当确定时执行
       //     $.post("<?php echo url('video/videodel'); ?>", {    // 网址、数据、成功后操作
       //     "_token": "{{ csrf_token() }}",
       //    "_method": "delete"
       //     }, function(data) {
       //     if (data.status == 0) {
