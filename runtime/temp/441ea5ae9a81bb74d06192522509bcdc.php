<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\wamp64\www\tp5\public/../application/admin\view\article\articlelist.html";i:1522128539;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <tbody>
                  <?php if(is_array($articlelist) || $articlelist instanceof \think\Collection || $articlelist instanceof \think\Paginator): $i = 0; $__LIST__ = $articlelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>
                            <u style="cursor:pointer" onclick="article_show('张三','article-show.html','10001','360','400')">
